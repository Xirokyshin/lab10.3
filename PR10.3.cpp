...
void displayMenu() {
    ...
    cout << "3. Показати людей, народжених під заданим знаком Зодіаку\n";
...
// Функція для сортування масиву за прізвищами (в алфавітному порядку)
...
// Функція для виводу людей, народжених під заданим знаком Зодіаку
void displayByZodiacSign(Zodiac* people, int size, const string& zodiacSign) {
    ...
    if (!found) {
        cout << "Немає людей, народжених під цим знаком Зодіаку.\n";
    }
}
